      ...
      <div className="neo4py-container py-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="/docs"
                  className="text-muted-foreground hover:text-neo4py"
                >
                  Documentation
                </a>
              </li>
              <li>
                <a href="#" className="text-muted-foreground hover:text-neo4py">
                  API Reference
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-gray-200 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a
              href="#"
              className="text-muted-foreground hover:text-neo4py text-sm"
            >
              Privacy Policy
            </a>
            <a
