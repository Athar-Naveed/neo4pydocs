...
const communityLinks = [
  {
    ...
    title: "GitHub",
    description: "Contribute to the library, report issues, or explore the source code.",
  ...
  },
  {
    ...
    description: "Join our Slack channel to connect with other Neo4py users and developers.",
    href: "#",
...
const Community = () => {
  return (
    <section id="community" className="py-20 bg-neo4py-super-light relative overflow-hidden">
      ...
      <div className="neo4py-container">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Join a growing community of developers building amazing things with Neo4py. Get help, share your projects, and contribute to the future of the library.
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center justify-between py-4 px-6 bg-white rounded-lg border border-neo4py/10 shadow-sm">
            <span className="text-muted-foreground mr-4">Star us on GitHub:</span>
