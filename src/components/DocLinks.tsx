...
`
  ...
  apiReference: {
    title: "API Reference",
    content: "The Neo4py API is designed to be intuitive and consistent. Here are the main components:",
...
`
  ...
  guides: {
    ...
    content: "Learn Neo4py through step-by-step guides covering common use cases and patterns.",
          ...
          <div className="lg:col-span-3 bg-white rounded-xl p-8 border border-gray-100 shadow-sm">
            {activeSection === "introduction" && (
              <div className="space-y-6">
                <h2 className="text-2xl font-bold text-gray-900">{documentationSections.introduction.title}</h2>
                <p className="text-gray-700 leading-relaxed">{documentationSections.introduction.content}</p>
                <CodeBlock 
            ...
            {activeSection === "api-reference" && (
              <div className="space-y-6">
                <h2 className="text-2xl font-bold text-gray-900">{documentationSections.apiReference.title}</h2>
                <p className="text-gray-700 leading-relaxed">{documentationSections.apiReference.content}</p>
                <CodeBlock 
                ...
                <div className="mt-8 space-y-6">
                  <div>
                    <h3 className="text-xl font-semibold text-gray-800 mb-3">Graph Class</h3>
                    <p className="text-gray-700 mb-2">The main entry point for Neo4py. Manages connections and provides methods for interacting with the database.</p>
                    <div className="bg-gray-50 p-4 rounded-lg border border-gray-100">
                      <code className="text-sm text-gray-800 font-mono">Graph(uri, auth=None, **config)</code>
                    </div>
                  </div>
                  
                  <div>
                    <h3 className="text-xl font-semibold text-gray-800 mb-3">Node Class</h3>
                    <p className="text-gray-700 mb-2">Represents a node in the graph with labels and properties.</p>
                    <div className="bg-gray-50 p-4 rounded-lg border border-gray-100">
                      <code className="text-sm text-gray-800 font-mono">Node(*labels, **properties)</code>
                    </div>
                  </div>
                  
                  <div>
                    <h3 className="text-xl font-semibold text-gray-800 mb-3">Relationship Class</h3>
                    <p className="text-gray-700 mb-2">Represents a relationship between nodes with a type and properties.</p>
                    <div className="bg-gray-50 p-4 rounded-lg border border-gray-100">
                      <code className="text-sm text-gray-800 font-mono">Relationship(start_node, type, end_node, **properties)</code>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {activeSection === "guides" && (
              <div className="space-y-6">
                <h2 className="text-2xl font-bold text-gray-900">{documentationSections.guides.title}</h2>
                <p className="text-gray-700 leading-relaxed">{documentationSections.guides.content}</p>
                <CodeBlock 
                ...
                />
                <div className="mt-8">
                  <h3 className="text-xl font-semibold text-gray-800 mb-4">Popular Guides</h3>
                  <ul className="space-y-3">
                    <li>
                      <a href="#" className="flex items-center p-3 bg-neo4py-super-light rounded-lg hover:bg-neo4py-light/20 transition-colors">
                        <FileText className="h-5 w-5 text-neo4py mr-3" />
                        <span className="font-medium text-gray-800">Getting Started with Neo4py</span>
                      </a>
                    </li>
                    <li>
                      <a href="#" className="flex items-center p-3 bg-neo4py-super-light rounded-lg hover:bg-neo4py-light/20 transition-colors">
                        <FileText className="h-5 w-5 text-neo4py mr-3" />
                        <span className="font-medium text-gray-800">Building a Recommendation Engine</span>
                      </a>
                    </li>
                    <li>
                      <a href="#" className="flex items-center p-3 bg-neo4py-super-light rounded-lg hover:bg-neo4py-light/20 transition-colors">
                        <FileText className="h-5 w-5 text-neo4py mr-3" />
                        <span className="font-medium text-gray-800">Working with Large Datasets</span>
                      </a>
                    </li>
                  </ul>
                </div>
            ...
            {activeSection === "query-building" && (
              <div className="space-y-6">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Neo4py provides a powerful query builder that makes it easy to construct complex Cypher queries.
                </p>
                <CodeBlock 
...
`} 
            ...
            {activeSection === "data-modeling" && (
              <div className="space-y-6">
                <h2 className="text-2xl font-bold text-gray-900">Data Modeling with Neo4py</h2>
                <p className="text-gray-700 leading-relaxed">
                  Learn best practices for modeling your domain as a graph using Neo4py's object-graph mapping capabilities.
                </p>
                <CodeBlock 
...
`} 
            ...
            {activeSection === "troubleshooting" && (
              <div className="space-y-6">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Solutions to common issues you might encounter when working with Neo4py.
                </p>
                
                <div className="bg-amber-50 border-l-4 border-amber-400 p-4 rounded-r-lg">
                  <h3 className="text-lg font-medium text-amber-800 mb-2">Connection Issues</h3>
                  <p className="text-amber-700">
                    If you're having trouble connecting to your Neo4j database, check your credentials and make sure the database is running.
                  </p>
                  <CodeBlock 
...
`} 
                ...
                <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-r-lg mt-6">
                  <h3 className="text-lg font-medium text-blue-800 mb-2">Performance Optimization</h3>
                  <p className="text-blue-700">
                    If your queries are running slowly, consider using these optimization techniques.
                  </p>
